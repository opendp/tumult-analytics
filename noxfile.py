...
DEPENDENCY_MATRIX = {
    ...
    for (name, python, pyspark, sympy, pandas, core) in [
        # fmt: off
        ("3.7-oldest",     "3.7",  "==3.1.1", "==1.8", "==1.2.0", "==0.14.0"),
        ("3.7-pyspark3.2", "3.7",  "==3.2.0", "==1.9", "==1.3.5", ">=0.14.0"),
        ("3.7-newest",     "3.7",  "==3.3.3", "==1.9", "==1.3.5", ">=0.14.0"),
        ("3.8-oldest",     "3.8",  "==3.1.1", "==1.8", "==1.2.0", "==0.14.0"),
        ("3.8-newest",     "3.8",  "==3.5.0", "==1.9", "==1.5.3", ">=0.14.0"),
        ("3.9-oldest",     "3.9",  "==3.1.1", "==1.8", "==1.2.0", "==0.14.0"),
        ("3.9-newest",     "3.9",  "==3.5.0", "==1.9", "==1.5.3", ">=0.14.0"),
        ("3.10-oldest",    "3.10", "==3.1.1", "==1.8", "==1.4.0", "==0.14.0"),
        ("3.10-newest",    "3.10", "==3.5.0", "==1.9", "==1.5.3", ">=0.14.0"),
        ("3.11-oldest",    "3.11", "==3.4.0", "==1.8", "==1.5.0", "==0.14.0"),
        ("3.11-newest",    "3.11", "==3.5.0", "==1.9", "==1.5.3", ">=0.14.0"),
        # fmt: on
    ]
}
