...
DEPENDENCY_MATRIX = {
    ...
    for (name, python, pyspark, sympy, pandas, core) in [
        ...
        ("3.10-newest",    "3.10", "==3.5.1", "==1.9", "==1.5.3", ">=0.17.0"),
        ("3.11-oldest",    "3.11", "==3.4.0", "==1.8", "==1.5.0", "==0.17.0"),
        ("3.11-newest",    "3.11", "==3.5.1", "==1.9", "==1.5.3", ">=0.17.0"),
        ("3.12-oldest",    "3.12", "==3.5.0", "==1.8", "==2.2.0", "==0.17.0"),
        ("3.12-newest",    "3.12", "==3.5.1", "==1.9", "==2.2.2", ">=0.17.0"),
        # fmt: on
    ]
}
